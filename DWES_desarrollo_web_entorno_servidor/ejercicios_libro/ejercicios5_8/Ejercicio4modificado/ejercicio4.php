...
<body>
    ...
    if (isset($_REQUEST['persona'])) {
        ...
        $personas[] = ['nombre' => $persona[0], 'sexo' => $persona[1], 'orientacion' => $persona[2]];
    } else {
        $personas = [
    ...
    <form action="" method="post">
        Nombre: <input type="text" name="persona[]"><br>
        Sexo: <input type="text" name="persona[]"><br>
        orientación: <input type="text" name="persona[]"><br>
