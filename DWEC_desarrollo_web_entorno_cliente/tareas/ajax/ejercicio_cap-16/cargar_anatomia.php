...
require_once 'Anatomia.php'; // Incluir la clase Comunidades
...
$id_organo = $_REQUEST['id'];

$consulta = $conexion->query("SELECT * FROM anatomia WHERE id='$id_organo'"); // Realizar una consulta SQL
$reg = $consulta->fetchObject();
$organo = new Anatomia($reg->id, $reg->descripcion);
...
$item = $xml->addChild('organo');
$item->addChild('descripcion', $organo->descripcion);
