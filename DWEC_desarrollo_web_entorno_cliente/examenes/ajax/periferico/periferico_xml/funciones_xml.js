    ...
    if (conexion1.status == 200) {
      ...
      try {
        ...
        for (let f = 0; f < perifericos.length; f++) {
          ...
          let codigo =
            perifericos[f].getElementsByTagName("codigo")[0].textContent;
          let descripcion =
            perifericos[f].getElementsByTagName("descripcion")[0].textContent;
          let precio =
            perifericos[f].getElementsByTagName("precio")[0].textContent;
          let descuento =
            perifericos[f].getElementsByTagName("descuento")[0].textContent;
