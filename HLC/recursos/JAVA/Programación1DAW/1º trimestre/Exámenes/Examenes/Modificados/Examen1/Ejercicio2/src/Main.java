...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= (numast/10)+1; i++) { // bucle for que pinta las filas de asteriscos empleados
            for (int j = 1; j <= 10; j++) { // bucle for que pinta el número de asteriscos empleados de 10 en 10
                if (astaux>0) {
                    System.out.print("*");
                    astaux--;
                }
